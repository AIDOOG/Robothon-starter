...
- `validate_submission.py`, `JUDGE_BRIEF.md`, `submission_manifest.json`, and `rubric_scorecard.json` provide a compact review path for the official scoring dimensions without adding unverified claims.
...
submissions/aidoog_sentinel_sorter/rubric_scorecard.json
...
Recommended review path: run `python3 submissions/aidoog_sentinel_sorter/validate_submission.py`, open the video, then inspect `JUDGE_BRIEF.md`, `data/rollout_summary.json`, and `data/sensor_log.csv`.
