...
- The script writes `data/sensor_log.csv`, `data/rollout_summary.json`, `data/behavior_policy.json`, `data/randomized_layouts.json`, `data/contact_timeline.json`, `data/stress_eval.json`, `data/policy_card.json`, `data/narration.srt`, `data/keyframes.png`, `rubric_scorecard.json`, `submission_manifest.json`, and `JUDGE_BRIEF.md` for reproducibility, scoring evidence, and dataset review.
...
- Judge-facing contact timeline, policy card, stress evaluation, rubric scorecard, SRT narration, manifest, and keyframe storyboard generated by the submitted code.
...
submissions/aidoog_sentinel_sorter/data/policy_card.json
submissions/aidoog_sentinel_sorter/data/narration.srt
submissions/aidoog_sentinel_sorter/data/keyframes.png
